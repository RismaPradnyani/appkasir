            ...
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>
                            <a
                                href="aksi/penjualan.php?aksi=hapus-keranjang&ProdukID=<?=$keranjang['ProdukID']; ?>">
                ...
                <button class="btn btn-block btn-dark mt-3" data-toggle="modal" data-target="#simpanJual">
                    <i class="fas fa-save">
                        Simpan Penjualan</i>
                </button>
            </div>
        ...
        <table id="example1" class="table table-hover">
          ...
          ?>
            <tr>
              ...
              <td>
                <!-- tombol pilih -->
                <button class="btn btn-secondary small" type="submit"><i class="fas fa-check"></i> Pilih</button>
                </form>
              </td>
            </tr>
            <?php } ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="aksi/penjualan.php" method="post">
                    ...
                    <button class="btn btn-dark mt-3 btn-block" type="submit"><i class="fas fa-save"> Simpan Penjualan</i></button>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
